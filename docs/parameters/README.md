...
- GUI defaults in `_build_ui()` in `pyBEHAVIOR_v5.py`.
...
The compact user-facing parameter table is in `pyBEHAVIOR_v5_parameters.md`.
...
9. Update `pyBEHAVIOR_v5_parameters.md` and this documentation if behavior changes.
